...
class DiscoverLoops {
  ...
  /// The first element is the FieldRef corresponding to the graph vertex.
  /// The second element is the list of vertices, that have an edge to this
  /// vertex. The directed edges represent a reaching definition from the source
  /// to the sink.
  ...
  void constructReachingDefGraph(FModuleOp module) {
    ...
    for (auto &op : module) {
      llvm::TypeSwitch<Operation *>(&op)
          ...
          .Case<InstanceOp>([&](auto op) { handleInstanceOp(op); })
